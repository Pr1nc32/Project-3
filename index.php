		...
		<ul id="demo1">
			<li>
				...
				<div class="slide-desc">
					<h3>Buy ALL Grocery Products From Here</h3>
				</div>
			</li>
			<li>
				<img src="images/22.jpg" alt="" />
				  <div class="slide-desc">
				  <h3>Buy All Households Product From Here👍</h3>
...
<?php
$sqlproduct= "SELECT * FROM product LEFT JOIN category ON product.catid=category.catid where product.status='Active' AND discount>='1' ORDER BY rand() LIMIT 6";
